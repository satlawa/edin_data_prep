...
class DatasetCreation(object):
    ...
    def add_dataset_to_hdf5(self, block_size, start_index=0, sort=False, type_mask='ground_truth', shape='ortho', paths=[]):
        # open hdf5 file
    ...
    def find_files(self, dir_img, data_types, sort=False):
        ...
        for file in os.listdir("{}{}/".format(dir_img, data_types[2])):
            if file[-4:] == ".tif":
